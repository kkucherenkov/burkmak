...
- Run `prisma db push` — **prohibited**. Every schema change is a committed Prisma migration (`prisma migrate dev` locally; the container/CI apply via `prisma migrate deploy`).
