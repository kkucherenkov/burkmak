...
class ExtractionApi {
  ...
  const ExtractionApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [ExtractAccepted] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ExtractAccepted>> extractArticle({ 
    required String id,
    ...
    final _path = r'/api/v1/items/{id}/extract'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    ...
    ExtractAccepted? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ExtractAccepted),
      ) as ExtractAccepted;
    ...
    return Response<ExtractAccepted>(
      data: _responseData,
  ...
  Future<Response<Article>> getArticle({ 
    ...
    final _path = r'/api/v1/items/{id}/article'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Parameters:
  /// * [id] - Item ID (cuid)
  /// * [key] - Opaque image key assigned by the extraction job. Clients MUST NOT construct this value: the extraction job rewrites `<img src>` URLs inside `Article.contentHtml` to `/api/v1/items/{id}/image/{key}` paths, so clients only ever follow keys that already appear in the article HTML. 
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<Uint8List>> getItemImage({ 
    ...
    final _path = r'/api/v1/items/{id}/image/{key}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString()).replaceAll('{' r'key' '}', encodeQueryParameter(_serializers, key, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
