...
class TokensApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [PersonalAccessTokenCreated] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<PersonalAccessTokenCreated>> createToken({ 
    required CreateTokenRequest createTokenRequest,
    ...
    try {
      ...
      _bodyData = _serializers.serialize(createTokenRequest, specifiedType: _type);
    ...
    PersonalAccessTokenCreated? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(PersonalAccessTokenCreated),
      ) as PersonalAccessTokenCreated;
    ...
    return Response<PersonalAccessTokenCreated>(
      data: _responseData,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TokenList>> listTokens({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  ///
  /// Parameters:
  /// * [id] - Personal access token ID (cuid)
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<void>> revokeToken({ 
    ...
    final _path = r'/api/v1/tokens/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
