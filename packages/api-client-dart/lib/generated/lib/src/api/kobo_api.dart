...
class KoboApi {
  ...
  const KoboApi(this._dio, this._serializers);
  ...
  Future<Response<Uint8List>> getItemEpub({ 
    required String id,
    ...
    final _path = r'/api/v1/items/{id}/epub'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<String>> getOpdsFeed({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
