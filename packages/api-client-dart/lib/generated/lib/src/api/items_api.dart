...
class ItemsApi {
  ...
  Future<Response<Item>> addItemTag({ 
    required String id,
    required AddTagRequest addTagRequest,
    ...
    final _path = r'/api/v1/items/{id}/tags'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    ...
    try {
      const _type = FullType(AddTagRequest);
      _bodyData = _serializers.serialize(addTagRequest, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ItemList] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ItemList>> listItems({ 
    ...
    ItemList? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ItemList),
      ) as ItemList;
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> removeItemTag({ 
    required String id,
    ...
    final _path = r'/api/v1/items/{id}/tags/{tagSlug}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString()).replaceAll('{' r'tagSlug' '}', encodeQueryParameter(_serializers, tagSlug, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Item] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Item>> saveItem({ 
    required SaveItemRequest saveItemRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(SaveItemRequest);
      _bodyData = _serializers.serialize(saveItemRequest, specifiedType: _type);
