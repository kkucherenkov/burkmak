...
class TagsApi {
  ...
  Future<Response<void>> deleteTag({ 
    ...
    final _path = r'/api/v1/tags/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TagList>> listTags({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> renameTag({ 
    required String id,
    required RenameTagRequest renameTagRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(RenameTagRequest);
      _bodyData = _serializers.serialize(renameTagRequest, specifiedType: _type);
