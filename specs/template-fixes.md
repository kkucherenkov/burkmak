...
- **Commit:** `e11e287` (task `T-2026-06-14-002`).
...
- **Commit:** shipped in S1-mobile (task `T-2026-06-14-005`, merge `d0eaf5e`).
...
- **Commits:** `f4f88f1` (T-013, the SCSS symptom fix) + `8c91874` (T-015, the structural gate fix).
