...
- Sub-steps (phases):
  ...
  - [x] Phase B: pure extractor core (TDD) + ports/adapters + image cache + ArticleRepo + FTS in listItems (2b4fc91, 03161a8, 76b0e1c)
  - [ ] Phase C: extract_article job handler (TDD) + register; ExtractArticle cmd + GetArticle query + controller routes + image serving
  - [ ] Phase D: highlights module (ports, repo, commands/queries, controller, module)
