    ...
    <main class="app-card app-auth__card" aria-labelledby="signup-title">
      ...
      <div class="app-auth__head">
        ...
        <p class="app-auth__subtitle">
          Save your first article in under a minute — it’s yours to keep.
        </p>
      </div>
      ...
      <template v-else>
          ...
          <div class="app-field">
            ...
            <div class="app-input-wrap">
              ...
              >
                ...
                >
                  <path d="M3 3l18 18" />
                  <path d="M10.6 5.1A9.7 9.7 0 0 1 12 5c5 0 9 4.5 9 7a12 12 0 0 1-2.2 3" />
            ...
            <p v-else id="signup-password-hint" class="app-field__hint">
        ...
        <p class="app-auth__meta">Already have a library? <a href="#/sign-in">Sign in</a></p>
      </template>
    </main>
  </div>
</template>
